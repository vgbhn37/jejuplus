...
<body>
	...
	<div id="box">		
		...
		<br>
		<div id="tag">${lodgingDetail.tag}</div>
		<div><input type="hidden" value="${lodgingDetail.contentsLabel}" id="contentsLabel"></div>
		<br><hr>
...
<script>
	...
	// 마커가 표시될 위치
	var markerPosition  = new kakao.maps.LatLng("${lodgingDetail.latitude}", "${lodgingDetail.longitude}"); 
